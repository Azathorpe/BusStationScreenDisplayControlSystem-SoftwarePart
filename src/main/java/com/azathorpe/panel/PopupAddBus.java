...
public class PopupAddBus extends JPanel {
    ...
    public PopupAddBus() {
        ...
        this.add(new JLabel("车次(int, -1使用自增主键):"));
        this.add(busIDField);
        ...
        addButton.addActionListener(e -> {
            ...
            //调用工具 添加bus
            DataBaseUtils.addQuery(Bus.getInstance(busID, busName, startTime, ticket, destination, nextStation, com.azathorpe.Entities.BusStatue.valueOf(busStatue)));
        });
    }
}
